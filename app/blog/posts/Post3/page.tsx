        ...
        <div className="post">
            ...
            <div className="post-content">
                ...
                <p>
                    ...
                    We have BIG IDEAS for this project and have high expectations for it. My group members are great and I look forward to working with them.

                    <br></br>
                    <br></br>


                    We already have a working prototype with a ball that bounces and speeds up when shaking! Very exciting!
                </p>
            </div>
